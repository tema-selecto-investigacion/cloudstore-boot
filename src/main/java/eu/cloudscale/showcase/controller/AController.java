...
//	@Qualifier("service")
	...
	public HttpSession getHttpSession(Class c, HttpServletRequest request)
	{
		...
		Logger log = LoggerFactory.getLogger(c.getName());
...
//		model.addAttribute( "jsResourceUrl", getApplicationProperties().get( "eu.cloudscale.files.url.js" ));
		...
		model.addAttribute("jsResourceUrl", "/js");
		model.addAttribute("imgResourceUrl", "/img");
		model.addAttribute("cssResourceUrl", "/css");
	}
